...
import ute.mobile.back_end_for_BOOKING.infrastructure.dto.JwtType;
...
public class SecurityProvider {
    ...
    // getSecretKey //
    private byte[] getSecretKey(ute.mobile.back_end_for_BOOKING.infrastructure.dto.JwtType jwtType) {
    ...
    private String genToken(User user, JwtType jwtType) {
        ...
        try {
            ...
            throw new UnAuthE("Failed to gen token");
        }
    }
